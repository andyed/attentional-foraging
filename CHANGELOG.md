...
- Approach-retreat repo (`~/Documents/dev/approach-retreat`) was forked from NB15's pre-fix features JSON — its library constants, demo JSONs, and README numbers inherit the bug and need regeneration. **Tackle last** per Andy (2026-04-09).
