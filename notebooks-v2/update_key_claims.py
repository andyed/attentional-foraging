...
def emit_aggregate_doc() -> None:
    ...
    lines.append("")
    lines.append(
        "> **Substrate re-derivation notice (2026-08-28 / 2026-08-30).** The typed / "
        "typed_gapfill AOI substrate was re-derived twice in late August 2026: the "
        "**2026-08-28 y-DP geometric realignment** (index matching \u2192 monotonic DP on "
        "rendered card geometry; see `docs/local-pack-aoi-shift.md`) and the **2026-08-30 "
        "AOI card-collision fix** (producer `86f800a3`, substrate `2da0544d`/`574218b6`; "
        "corpus 2,776 \u2192 2,764 trials, 12 alignment-excluded, typed maps content hash "
