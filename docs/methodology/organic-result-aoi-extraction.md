...
- **methods paper** — algorithmic submission. Per-result-AOI episode geometry depends on the typed cascade for the four-class taxonomy (clicked / deferred / evaluated-rejected / not-approached) when widget surfaces enter the consideration set.
