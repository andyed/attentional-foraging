...
1. **Within-page re-evaluation modeling** — MVT/IFT model patch-leaving but not patch-revisiting. We show regressions serve two distinct functions: confirmation (to the winner, +15% fixations) and rejection (of alternatives, -18% fixations). This is a new behavioral decomposition. [Values corrected 2026-08-30: the +32%/-17% previously here were unreproducible prose; canonical source `scripts/output/revisit_fixations_by_click/summary.json`, typed_gapfill.]
