...
| **Lexical priming and evaluation speed** | **No prior work found.** Position bias literature (Joachims 2005, Craswell 2008) attributes speed-up to trust. Gwizdka 2010/2014 on cognitive load. | **Novel question, null at three granularities.** Bag-of-words, semantic embeddings (mxbai-embed-large), within-position controls — all null. Forward-only dwell increases with position (ρ = +0.82). Most parsimonious: cognitive load from growing working memory candidate set. Token-level fixation analysis remains untested. | Joachims et al. 2005; Hale 2001 / Levy 2008 (surprisal theory); Gwizdka 2010 |
