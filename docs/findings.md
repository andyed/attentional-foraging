...
> **2026-09-14.** The four states of result evaluation (peripheral / rejected / deferred / clicked), the return mechanism and continuation measured four ways are written up on their own page, [`findings-result-evaluation-states.md`](findings-result-evaluation-states.md), from post-fix producers. Sections below keep their numbering so external links survive.
