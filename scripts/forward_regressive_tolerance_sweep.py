...
for the paper draft to pull from.
...
fragile and should carry a sensitivity footnote in the paper draft.
"""
...
def main(tol_pxs=(25, 50, 100, 200)):
    ...
    lines = []
    lines.append('# Forward/Regressive Split — Paper Headlines')
    lines.append('')
