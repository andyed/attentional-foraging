...
def compute_canonical_features(xs: np.ndarray, ys: np.ndarray, ts: np.ndarray,
    ...
    # Floor dt + clamp velocity so a tiny gap can't manufacture an impossible
    # speed (rationale in m4_nb21_hybrid_rerun.py). Clamp is symmetric →
    # sign-based features and the negative mean unaffected.
